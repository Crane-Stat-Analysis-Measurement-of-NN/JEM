...
for i in range(48,49): 
    for scoretype in ["px","py","pxgrad"]:
        for evaltype in ["OOD","logp_hist"]:
            ...
            inline_parms = {"load_path": indir+"ckpt_48_1-23.pt",                             "fig_pre": "jp"+str(i)+"_"+scoretype,                             "eval": evaltype,                             "datasets": ["cifar10",'svhn'],                             #px, py, pxgrad
                            "score_fn": scoretype, \
                            "save_dir": outdir}
    ...
    # setup change from defaults
    inline_parms = {"load_path": indir+"ckpt_48_1-23.pt",                     "fig_pre": "jp"+str(i)+"_"+scoretype,                     "eval": "pri_energy",                     "datasets": ["cifar10",'svhn'],                     "fig_pre": "ckpt"+str(i)+"_",                     "save_dir": outdir}
